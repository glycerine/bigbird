/* Generated from utils.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   2013-10-03 20:48
   Version 4.8.0.5 (stability/4.8.0) (rev 5bd53ac)
   macosx-unix-clang-x86-64 [ 64bit manyargs ptables ]
   compiled 2013-10-03 on aeryn.xorinia.dim (Darwin)
   command line: utils.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -no-warnings -specialize -types ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file utils.import.c
...
/* utils.import.scm:27: ##sys#register-primitive-module */
...
if(!C_demand_2(111)){
C_save(t1);
C_rereclaim2(111*sizeof(C_word), 1);
t1=C_restore;}
a=C_alloc(3);
C_initialize_lf(lf,3);
lf[0]=C_h_intern(&lf[0],29,"\003sysregister-primitive-module");
lf[1]=C_h_intern(&lf[1],5,"utils");
lf[2]=C_decode_literal(C_heaptop,"\376\003\000\000\002\376\001\000\000\010read-all\376\003\000\000\002\376\001\000\000\007system\052\376\003\000\000\002\376\001\000\000\002qs\376\003\000\000\002\376\001\000\000\014compile-file\376\003\000\000\002\376\001\000\000\024c"
"ompile-file-options\376\003\000\000\002\376\001\000\000\020scan-input-lines\376\003\000\000\002\376\001\000\000\012yes-or-no\077\376\377\016");
...
{"f_174:utils_2eimport_2escm",(void*)f_174},
{"f_176:utils_2eimport_2escm",(void*)f_176},
{"toplevel:utils_2eimport_2escm",(void*)C_toplevel},
{"f_172:utils_2eimport_2escm",(void*)f_172},
{NULL,NULL}};
#endif
