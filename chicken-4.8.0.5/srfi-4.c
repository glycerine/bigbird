...
t4=C_eqp(t3,lf[128]);
t5=(C_truep(t4)?t4:C_eqp(t3,lf[129]));
if(C_truep(t5)){
t6=((C_word*)t0)[2];
...
t3=*((C_word*)lf[119]+1);
t4=C_a_i_list(&a,16,lf[120],*((C_word*)lf[56]+1),lf[121],*((C_word*)lf[58]+1),lf[122],*((C_word*)lf[59]+1),lf[123],*((C_word*)lf[60]+1),lf[124],*((C_word*)lf[61]+1),lf[125],*((C_word*)lf[62]+1),lf[126],*((C_word*)lf[63]+1),lf[127],*((C_word*)lf[64]+1));
t5=C_mutate((C_word*)lf[119]+1 /* (set! ##sys#user-read-hook ...) */,(*a=C_CLOSURE_TYPE|4,a[1]=(C_word)f_3416,a[2]=t4,a[3]=t3,a[4]=((C_word)li108),tmp=(C_word)a,a+=5,tmp));
t6=*((C_word*)lf[133]+1);
t7=C_mutate((C_word*)lf[133]+1 /* (set! ##sys#user-print-hook ...) */,(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_3469,a[2]=t6,a[3]=((C_word)li109),tmp=(C_word)a,a+=4,tmp));
t8=C_mutate(&lf[135] /* (set! subnvector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3523,a[2]=((C_word)li112),tmp=(C_word)a,a+=3,tmp));
t9=C_mutate((C_word*)lf[136]+1 /* (set! subu8vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3597,a[2]=((C_word)li113),tmp=(C_word)a,a+=3,tmp));
t10=C_mutate((C_word*)lf[137]+1 /* (set! subu16vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3603,a[2]=((C_word)li114),tmp=(C_word)a,a+=3,tmp));
t11=C_mutate((C_word*)lf[138]+1 /* (set! subu32vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3609,a[2]=((C_word)li115),tmp=(C_word)a,a+=3,tmp));
t12=C_mutate((C_word*)lf[139]+1 /* (set! subs8vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3615,a[2]=((C_word)li116),tmp=(C_word)a,a+=3,tmp));
t13=C_mutate((C_word*)lf[140]+1 /* (set! subs16vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3621,a[2]=((C_word)li117),tmp=(C_word)a,a+=3,tmp));
t14=C_mutate((C_word*)lf[141]+1 /* (set! subs32vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3627,a[2]=((C_word)li118),tmp=(C_word)a,a+=3,tmp));
t15=C_mutate((C_word*)lf[142]+1 /* (set! subf32vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3633,a[2]=((C_word)li119),tmp=(C_word)a,a+=3,tmp));
t16=C_mutate((C_word*)lf[143]+1 /* (set! subf64vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3639,a[2]=((C_word)li120),tmp=(C_word)a,a+=3,tmp));
t17=C_mutate((C_word*)lf[144]+1 /* (set! write-u8vector ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3645,a[2]=((C_word)li122),tmp=(C_word)a,a+=3,tmp));
t18=C_mutate((C_word*)lf[148]+1 /* (set! read-u8vector! ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3728,a[2]=((C_word)li123),tmp=(C_word)a,a+=3,tmp));
t19=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3799,a[2]=((C_word)li124),tmp=(C_word)a,a+=3,tmp);
t20=C_mutate((C_word*)lf[152]+1 /* (set! read-u8vector ...) */,(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_3807,a[2]=t19,a[3]=((C_word)li126),tmp=(C_word)a,a+=4,tmp));
t21=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_3895,a[2]=((C_word*)t0)[2],tmp=(C_word)a,a+=3,tmp);
/* srfi-4.scm:693: register-feature! */
t22=*((C_word*)lf[157]+1);
((C_proc3)(void*)(*((C_word*)t22+1)))(3,t22,t21,lf[158]);}
...
lf[120]=C_h_intern(&lf[120],2,"u8");
lf[121]=C_h_intern(&lf[121],2,"s8");
lf[122]=C_h_intern(&lf[122],3,"u16");
lf[123]=C_h_intern(&lf[123],3,"s16");
lf[124]=C_h_intern(&lf[124],3,"u32");
lf[125]=C_h_intern(&lf[125],3,"s32");
lf[126]=C_h_intern(&lf[126],3,"f32");
lf[127]=C_h_intern(&lf[127],3,"f64");
lf[128]=C_h_intern(&lf[128],1,"f");
lf[129]=C_h_intern(&lf[129],1,"F");
lf[130]=C_h_intern(&lf[130],4,"read");
...
t6=C_a_i_list(&a,3,lf[4],lf[120],*((C_word*)lf[65]+1));
t7=C_a_i_list(&a,3,lf[6],lf[121],*((C_word*)lf[66]+1));
t8=C_a_i_list(&a,3,lf[8],lf[122],*((C_word*)lf[67]+1));
t9=C_a_i_list(&a,3,lf[10],lf[123],*((C_word*)lf[68]+1));
t10=C_a_i_list(&a,3,lf[12],lf[124],*((C_word*)lf[69]+1));
t11=C_a_i_list(&a,3,lf[14],lf[125],*((C_word*)lf[70]+1));
t12=C_a_i_list(&a,3,lf[16],lf[126],*((C_word*)lf[71]+1));
t13=C_a_i_list(&a,3,lf[18],lf[127],*((C_word*)lf[72]+1));
